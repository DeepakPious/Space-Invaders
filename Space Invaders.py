...
# Player player
YELLOW_SPACE_SHIP = pygame.image.load(os.path.join("Resources", "Player.png"))
...
# Background
BG = pygame.transform.scale(pygame.image.load(os.path.join("Resources", "intro.png")), (WIDTH, HEIGHT))
BG2=pygame.transform.scale(pygame.image.load(os.path.join("Resources","BG.png")),(WIDTH,HEIGHT))
